...
data$date_readmission_3mo <- as.Date(data$date_readmission_3mo, format='%Y-%m-%d')
data$days1 <- as.numeric(data$date_readmission_3mths - data$date_surgery)
data$days2 <- as.numeric(data$date_readmission_3mo - data$date_surgery)
...
data$readmit3m <- ifelse(data$readmit_3months %in% 1 | data$readmit_3mth_surg%in%c(1) | data$readmit_3mth_surg.12m%in%c(1), 1, 0)
data$readmit3m <- factor(data$readmit3m, levels=c("1", "0"))

data$return_to_activities = factor(data$return_to_activities,levels=c("1","0"))
...
data$mort3m <- ifelse(data$mort30d %in% c('1') | data$patient_interview_status %in% 9, 1, 0)
...
tab2fun <- function(datas) {
  ...
  #   M[32,] <- catfun1(var1="employment", var2="employment", ilev="2", dfs=datas)
  #   M[33,] <- catfun1(var1="employed_not_working", var2="employed_not_working", ilev="1", dfs=datas)
  #   M[34,] <- catfun1(var1="employed_not_working", var2="employed_not_working", ilev="2", dfs=datas)
...
tab4fun <- function(datas) {
  M <- matrix("", nrow=17, ncol=2)
  M[1,] <- catfun1(var1="revision", var2="revision", ilev="1", dfs=datas)
  M[3,] <- catfun1(var1="principal_spine_diagnosis1", var2="principal_spine_diagnosis1", ilev="1", dfs=datas)
  M[4,] <- catfun1(var1="principal_spine_diagnosis2", var2="principal_spine_diagnosis2", ilev="1", dfs=datas)
  M[5,] <- catfun1(var1="principal_spine_diagnosis3", var2="principal_spine_diagnosis3", ilev="1", dfs=datas)
  M[6,] <- catfun1(var1="principal_spine_diagnosis4", var2="principal_spine_diagnosis4", ilev="1", dfs=datas)
  M[7,] <- catfun1(var1="principal_spine_diagnosis5", var2="principal_spine_diagnosis5", ilev="1", dfs=datas)
  M[8,] <- catfun1(var1="principal_spine_diagnosis6", var2="principal_spine_diagnosis6", ilev="1", dfs=datas)
  M[10,] <- catfun1(var1="dominant_symptom1", var2="dominant_symptom1", ilev="1", dfs=datas)
  M[11,] <- catfun1(var1="dominant_symptom1", var2="dominant_symptom1", ilev="2", dfs=datas)
  M[12,] <- catfun1(var1="dominant_symptom1", var2="dominant_symptom1", ilev="3", dfs=datas)
  M[13,] <- catfun1(var1="motor_def2", var2="motor_def2", ilev="1", dfs=datas)
  M[15,] <- catfun1(var1="symptom_duration2", var2="symptom_duration2", ilev="1", dfs=datas)
  M[16,] <- catfun1(var1="symptom_duration2", var2="symptom_duration2", ilev="2", dfs=datas)
  M[17,] <- catfun1(var1="symptom_duration2", var2="symptom_duration2", ilev="3", dfs=datas)
  return(M)
}
...
tab5fun <- function(datas) {
  ...
  M[2,] <- confun2(var1="back_pain_vas", dig=1, dfs=datas)
  M[3,] <- confun2(var1="leg_pain_vas1", dig=1, dfs=datas)
  M[4,] <- confun2(var1="odiscore", dig=1, dfs=datas)
  M[5,] <- confun2(var1="eq5dscore", dig=2, dfs=datas, dig2=2)
  return(M)
}


tab6fun <- function(datas) {
  M <- matrix("", nrow=92, ncol=2)
  ...
  M[6,] <- catfun1(var1="arthrodesis_performed", var2="arthrodesis_performed", ilev="1", dfs=datas)
  
  
  M[8,] <- catfun1(var1="surgical_approach", var2="surgical_approach", ilev="1", dfs=datas)
  M[9,] <- catfun1(var1="surgical_approach", var2="surgical_approach", ilev="2", dfs=datas)
  
  M[10,] <- catfun1(var1="surgical_approach", var2="surgical_approach", ilev="3", dfs=datas)
  M[11,] <- catfun1(var1="surgical_approach", var2="surgical_approach", ilev="4", dfs=datas)
  
  
  M[13,] <- catfun1(var1="laminectomy_performed", var2="laminectomy_performed", ilev="1", dfs=datas)
  M[14,] <- catfun1(var1="laminectomy_level", var2="laminectomy_performed", ilev="1", dfs=datas)
  M[15,] <- catfun1(var1="laminectomy_level", var2="laminectomy_performed", ilev="2", dfs=datas)
  M[16,] <- catfun1(var1="laminectomy_level", var2="laminectomy_performed", ilev="3", dfs=datas)
  M[17,] <- catfun1(var1="laminectomy_level", var2="laminectomy_performed", ilev="4", dfs=datas)
  M[18,] <- catfun1(var1="laminectomy_level", var2="laminectomy_performed", ilev="5", dfs=datas)
  M[19,] <- catfun1(var1="laminectomy_level", var2="laminectomy_performed", ilev="6", dfs=datas)
  M[20,] <- catfun1(var1="laminectomy_level", var2="laminectomy_performed", ilev="7", dfs=datas)
  
  M[22,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis1", ilev="0", dfs=datas)
  M[23,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis1", ilev="1", dfs=datas)
  M[24,] <- catfun1(var1="interbody_graft", var2="diagnosis1", ilev="1", dfs=datas)
  M[25,] <- catfun1(var1="laminectomy_performed", var2="diagnosis1", ilev="1", dfs=datas)
  M[26,] <- catfun1(var1="laminectomy_level", var2="diagnosis1", ilev="1", dfs=datas, var3="laminectomy_level")
  M[27,] <- catfun1(var1="laminectomy_level", var2="diagnosis1", ilev="2", dfs=datas, var3="laminectomy_level")
  M[28,] <- catfun1(var1="laminectomy_level", var2="diagnosis1", ilev="3", dfs=datas, var3="laminectomy_level")
  M[29,] <- catfun1(var1="laminectomy_level", var2="diagnosis1", ilev="4", dfs=datas, var3="laminectomy_level")
  M[30,] <- catfun1(var1="laminectomy_level", var2="diagnosis1", ilev="5", dfs=datas, var3="laminectomy_level")
  M[31,] <- catfun1(var1="laminectomy_level", var2="diagnosis1", ilev="6", dfs=datas, var3="laminectomy_level")
  M[32,] <- catfun1(var1="laminectomy_level", var2="diagnosis1", ilev="7", dfs=datas, var3="laminectomy_level")
  
  M[34,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis2", ilev="0", dfs=datas)
  M[35,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis2", ilev="1", dfs=datas)
  M[36,] <- catfun1(var1="interbody_graft", var2="diagnosis2", ilev="1", dfs=datas)
  M[37,] <- catfun1(var1="laminectomy_performed", var2="diagnosis2", ilev="1", dfs=datas)
  M[38,] <- catfun1(var1="laminectomy_level", var2="diagnosis2", ilev="1", dfs=datas, var3="laminectomy_level")
  M[39,] <- catfun1(var1="laminectomy_level", var2="diagnosis2", ilev="2", dfs=datas, var3="laminectomy_level")
  M[40,] <- catfun1(var1="laminectomy_level", var2="diagnosis2", ilev="3", dfs=datas, var3="laminectomy_level")
  M[41,] <- catfun1(var1="laminectomy_level", var2="diagnosis2", ilev="4", dfs=datas, var3="laminectomy_level")
  M[42,] <- catfun1(var1="laminectomy_level", var2="diagnosis2", ilev="5", dfs=datas, var3="laminectomy_level")
  M[43,] <- catfun1(var1="laminectomy_level", var2="diagnosis2", ilev="6", dfs=datas, var3="laminectomy_level")
  M[44,] <- catfun1(var1="laminectomy_level", var2="diagnosis2", ilev="7", dfs=datas, var3="laminectomy_level")
  
  M[46,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis3", ilev="0", dfs=datas)
  M[47,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis3", ilev="1", dfs=datas)
  M[48,] <- catfun1(var1="interbody_graft", var2="diagnosis3", ilev="1", dfs=datas)
  M[49,] <- catfun1(var1="laminectomy_performed", var2="diagnosis3", ilev="1", dfs=datas)
  M[50,] <- catfun1(var1="laminectomy_level", var2="diagnosis3", ilev="1", dfs=datas, var3="laminectomy_level")
  M[51,] <- catfun1(var1="laminectomy_level", var2="diagnosis3", ilev="2", dfs=datas, var3="laminectomy_level")
  M[52,] <- catfun1(var1="laminectomy_level", var2="diagnosis3", ilev="3", dfs=datas, var3="laminectomy_level")
  M[53,] <- catfun1(var1="laminectomy_level", var2="diagnosis3", ilev="4", dfs=datas, var3="laminectomy_level")
  M[54,] <- catfun1(var1="laminectomy_level", var2="diagnosis3", ilev="5", dfs=datas, var3="laminectomy_level")
  M[55,] <- catfun1(var1="laminectomy_level", var2="diagnosis3", ilev="6", dfs=datas, var3="laminectomy_level")
  M[56,] <- catfun1(var1="laminectomy_level", var2="diagnosis3", ilev="7", dfs=datas, var3="laminectomy_level")
  
  M[58,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis4", ilev="0", dfs=datas)
  M[59,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis4", ilev="1", dfs=datas)
  M[60,] <- catfun1(var1="interbody_graft", var2="diagnosis4", ilev="1", dfs=datas)
  M[61,] <- catfun1(var1="laminectomy_performed", var2="diagnosis4", ilev="1", dfs=datas)
  M[62,] <- catfun1(var1="laminectomy_level", var2="diagnosis4", ilev="1", dfs=datas, var3="laminectomy_level")
  M[63,] <- catfun1(var1="laminectomy_level", var2="diagnosis4", ilev="2", dfs=datas, var3="laminectomy_level")
  M[64,] <- catfun1(var1="laminectomy_level", var2="diagnosis4", ilev="3", dfs=datas, var3="laminectomy_level")
  M[65,] <- catfun1(var1="laminectomy_level", var2="diagnosis4", ilev="4", dfs=datas, var3="laminectomy_level")
  M[66,] <- catfun1(var1="laminectomy_level", var2="diagnosis4", ilev="5", dfs=datas, var3="laminectomy_level")
  M[67,] <- catfun1(var1="laminectomy_level", var2="diagnosis4", ilev="6", dfs=datas, var3="laminectomy_level")
  M[68,] <- catfun1(var1="laminectomy_level", var2="diagnosis4", ilev="7", dfs=datas, var3="laminectomy_level")
  
  M[70,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis5", ilev="0", dfs=datas)
  M[71,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis5", ilev="1", dfs=datas)
  M[72,] <- catfun1(var1="interbody_graft", var2="diagnosis5", ilev="1", dfs=datas)
  M[73,] <- catfun1(var1="laminectomy_performed", var2="diagnosis5", ilev="1", dfs=datas)
  M[74,] <- catfun1(var1="laminectomy_level", var2="diagnosis5", ilev="1", dfs=datas, var3="laminectomy_level")
  M[75,] <- catfun1(var1="laminectomy_level", var2="diagnosis5", ilev="2", dfs=datas, var3="laminectomy_level")
  M[76,] <- catfun1(var1="laminectomy_level", var2="diagnosis5", ilev="3", dfs=datas, var3="laminectomy_level")
  M[77,] <- catfun1(var1="laminectomy_level", var2="diagnosis5", ilev="4", dfs=datas, var3="laminectomy_level")
  M[78,] <- catfun1(var1="laminectomy_level", var2="diagnosis5", ilev="5", dfs=datas, var3="laminectomy_level")
  M[79,] <- catfun1(var1="laminectomy_level", var2="diagnosis5", ilev="6", dfs=datas, var3="laminectomy_level")
  M[80,] <- catfun1(var1="laminectomy_level", var2="diagnosis5", ilev="7", dfs=datas, var3="laminectomy_level")
  
  M[82,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis6", ilev="0", dfs=datas)
  M[83,] <- catfun1(var1="arthrodesis_performed", var2="diagnosis6", ilev="1", dfs=datas)
  M[84,] <- catfun1(var1="interbody_graft", var2="diagnosis6", ilev="1", dfs=datas)
  M[85,] <- catfun1(var1="laminectomy_performed", var2="diagnosis6", ilev="1", dfs=datas)
  M[86,] <- catfun1(var1="laminectomy_level", var2="diagnosis6", ilev="1", dfs=datas, var3="laminectomy_level")
  M[87,] <- catfun1(var1="laminectomy_level", var2="diagnosis6", ilev="2", dfs=datas, var3="laminectomy_level")
  M[88,] <- catfun1(var1="laminectomy_level", var2="diagnosis6", ilev="3", dfs=datas, var3="laminectomy_level")
  M[89,] <- catfun1(var1="laminectomy_level", var2="diagnosis6", ilev="4", dfs=datas, var3="laminectomy_level")
  M[90,] <- catfun1(var1="laminectomy_level", var2="diagnosis6", ilev="5", dfs=datas, var3="laminectomy_level")
  M[91,] <- catfun1(var1="laminectomy_level", var2="diagnosis6", ilev="6", dfs=datas, var3="laminectomy_level")
  M[92,] <- catfun1(var1="laminectomy_level", var2="diagnosis6", ilev="7", dfs=datas, var3="laminectomy_level")
...
tab7fun <- function(datas, datasb) {
  ...
  M[20,] <- catfun1(var1="pt_satisfaction_index", var2="pt_satisfaction_index", ilev="1", df=datas)
  M[21,] <- catfun1(var1="pt_satisfaction_index", var2="pt_satisfaction_index", ilev="2", df=datas)
  M[22,] <- catfun1(var1="pt_satisfaction_index", var2="pt_satisfaction_index", ilev="3", df=datas)
  M[23,] <- catfun1(var1="pt_satisfaction_index", var2="pt_satisfaction_index", ilev="4", df=datas)
  M[24,] <- catfun1(var1="pt_satisfaction_index2", var2="pt_satisfaction_index2", ilev="1", df=datas)
  ...
  M[31,] <- catfun1(var1="revision_surg_3mths", var2="revision_surg_3mths", ilev="1", df=datas)
...
tab8fun <- function(ptab, datas) {
  ...
  M[6,1:3] <- catfun2(ds=datas[[1]], vars='return_to_activities')
  M[6,4:6] <- catfun2(ds=datas[[2]], vars='return_to_activities')
...
tab9fun <- function(ptab, datas) {
  ...
  M[6,1:4] <- catfun2(ds=datas[[1]], vars=c('return_to_activities','return_to_activities.12m'))
  M[6,5:8] <- catfun2(ds=datas[[2]], vars=c('return_to_activities','return_to_activities.12m'))
...
for (w in seq(length(pracs))) {
  ...
  if (sum(tab>19) > 0) {
    ...
    nsg <- length(snam)
    for (k in seq(nsg)) {
      Sweave("lumbar_surgeon_report.rnw", output=paste(pracs[w], '_', snam[k], ".tex", sep="")) 
    }
  }
}
